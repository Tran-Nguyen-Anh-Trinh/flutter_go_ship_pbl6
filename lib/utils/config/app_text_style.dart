...
class AppTextStyle {
  ...
  static TextStyle w500s12(Color color, {double? height, double? letterSpacing}) {
    return _styleWith(FontWeight.w500, 12, color, height: height, letterSpacing: letterSpacing);
  }
  ...
  static TextStyle w500s17(Color color, {double? height, double? letterSpacing}) {
    return _styleWith(FontWeight.w500, 17, color, height: height, letterSpacing: letterSpacing);
  }
  ...
  static TextStyle w600s10(Color color, {double? height, double? letterSpacing}) {
    return _styleWith(FontWeight.w600, 10, color, height: height, letterSpacing: letterSpacing);
  }

  static TextStyle w600s12(Color color, {double? height, double? letterSpacing}) {
    return _styleWith(FontWeight.w600, 12, color, height: height, letterSpacing: letterSpacing);
  }
  ...
  static TextStyle w600s20(Color color, {double? height, double? letterSpacing}) {
    return _styleWith(FontWeight.w600, 20, color, height: height, letterSpacing: letterSpacing);
  }

  static TextStyle w600s22(Color color, {double? height, double? letterSpacing}) {
    return _styleWith(FontWeight.w600, 22, color, height: height, letterSpacing: letterSpacing);
  }

  static TextStyle w600s25(Color color, {double? height, double? letterSpacing}) {
    return _styleWith(FontWeight.w600, 25, color, height: height, letterSpacing: letterSpacing);
  }
  ...
  static TextStyle w700s18(Color color, {double? height, double? letterSpacing}) {
    return _styleWith(FontWeight.w700, 18, color, height: height, letterSpacing: letterSpacing);
  }
  ...
  static TextStyle w700s22(Color color, {double? height, double? letterSpacing}) {
    return _styleWith(FontWeight.w700, 22, color, height: height, letterSpacing: letterSpacing);
  }
