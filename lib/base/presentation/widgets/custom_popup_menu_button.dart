...
class CustomCheckedPopupMenuItem<T> extends CustomPopupMenuItem<T> {
  ...
  @override
  CustomPopupMenuItemState<T, CustomCheckedPopupMenuItem<T>> createState() => _CheckedPopupMenuItemState<T>();
}

class _CheckedPopupMenuItemState<T> extends CustomPopupMenuItemState<T, CustomCheckedPopupMenuItem<T>>
  ...
  Widget build(BuildContext context) {
    ...
    return SizedBox(
      ...
      child: CupertinoButton(
        ...
        onPressed: widget.enabled ? showButtonMenu : null,
        child: SizedBox(
          width: widget.iconSize ?? iconTheme.size ?? _kDefaultIconSize,
          height: widget.iconSize ?? iconTheme.size ?? _kDefaultIconSize,
...
class _EffectiveMouseCursor extends MaterialStateMouseCursor {
  ...
  @override
  String get debugDescription => 'MaterialStateMouseCursor(CustomPopupMenuItemState)';
}
